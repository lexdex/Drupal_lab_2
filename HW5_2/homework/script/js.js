      ...
      if (this.hasUnvisitedNeighbor(currCell)) {
        ...
        do {
          ...
          switch (dir) {
            ...
            // Here we switch on MazeCell states ,there can be 4 falls up,bottom,left,right
            case 0:
...
// function to allow movement on keyboard buttons
