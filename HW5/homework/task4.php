...
function luck($attempt) {
    switch ($attempt) {
        ...
        case 6:
            ...
            break;
        default :
            return 'Unexpected behaviour of the program!';
    }
}
function Rolldice () {
    $attempt1 = mt_rand(1, 6);
    echo '<h2>1st attempt and you get: '.luck($attempt1).'</h2>';
    $attempt2 = mt_rand(1, 6);
    echo '<h2>2nd attempt and you get: '.luck($attempt2).'</h2>';
